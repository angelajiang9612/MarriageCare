...
gen single_init=1 if r10mstat==5 | r10mstat==7 | r10mstat==8 //count as singled if divorced, widowed or never married. Don't include separated 
...
tab rmr_ever2 r10mstat, col
tab mar_par_ever r10mstat, col
