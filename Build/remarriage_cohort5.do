...
//this one seems to be the best for remarriage 

//choose one of the below cohorts. 

keep if hacohort==5 // HRS Main, keep those in main HRS cohort 

gen single_init=1 if r7mstat==5 | r7mstat==7 | r7mstat==8 //count as singled if divorced, widowed or never married. Don't include separated 
...
tab rmr_ever2 r7mstat, col
tab mar_par_ever r7mstat, col
